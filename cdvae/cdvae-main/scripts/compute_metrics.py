...
class GenEval(object):
    ...
    def get_comp_diversity(self):
        try:
            ...
            print(f"Error in comp diversity: {str(e)}")
            return {'comp_div': None}
    ...
    def get_struct_diversity(self):
        try:
            ...
            print(f"Error in struct diversity: {str(e)}")
            return {'struct_div': None}
    ...
    def get_metrics(self):
        ...
        try:
            ...
            print("Validity metrics computed")
            
            metrics.update(self.get_comp_diversity() or {})
            print("Composition diversity computed")
            
            metrics.update(self.get_struct_diversity() or {})
            print("Structure diversity computed")
            
            metrics.update(self.get_density_wdist())
            print("Density distribution computed")
            
            metrics.update(self.get_num_elem_wdist())
            print("Element distribution computed")
            
            metrics.update(self.get_prop_wdist())
            print("Property distribution computed")
            
            metrics.update(self.get_coverage() or {})
            print("Coverage metrics computed")
            
        except Exception as e:
            print(f"Error in metrics computation: {str(e)}")
